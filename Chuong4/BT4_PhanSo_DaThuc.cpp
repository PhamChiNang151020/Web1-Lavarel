...
void themCuoiPS_1_Tung(PhanSo_1_Tung x_1_Tung)
{
	...
	{
		NodePS_1_Tung* q_1_Tung = firstPS_1_Tung;
...
void themDonThuc_1_Tung(float hs_1_Tung, int sm_1_Tung)
{
	...
	{
		NodeDT_1_Tung* q_1_Tung = firstDT_1_Tung;
		while (q_1_Tung->link_1_Tung != NULL)
			q_1_Tung = q_1_Tung->link_1_Tung;
		q_1_Tung->link_1_Tung = p_1_Tung;
	}
...
void menu_1_Tung()
{
	cout << "======= BT4: DSLK DON - PHAN SO & DA THUC =======" << endl;
	cout << "--- Phan so ---" << endl;
