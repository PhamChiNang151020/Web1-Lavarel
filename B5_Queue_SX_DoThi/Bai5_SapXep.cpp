// Ho ten: Tung
// B5 - Bai 5: Bubble, Interchange, Quick, Heap, Merge
...
void Quick_1_Tung(int a_1_Tung[], int left_1_Tung, int right_1_Tung)
{
	...
	int x_1_Tung = a_1_Tung[(left_1_Tung + right_1_Tung) / 2];
...
{
	int largest_1_Tung = i_1_Tung;
	int l_1_Tung = 2 * i_1_Tung + 1;
	int r_1_Tung = 2 * i_1_Tung + 2;
